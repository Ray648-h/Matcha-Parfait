...
class LoginService:
    ...
    def is_logged_in(self, page, name: str) -> bool:
        ...
        try:
            # 修改：使用较短的超时时间，避免长时间等待
            # 淘宝页面可能永远达不到networkidle状态，所以使用domcontentloaded
    ...
    def login(self, url: str, name: str):
        ...
        try:
            ...
            page.wait_for_timeout(2000)  # 等待2秒让页面稳定
        except Exception as e:
            print(f"⚠️  重新加载页面时出错: {e}")
